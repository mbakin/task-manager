            ...
            <ul className="pt-1 pb-3 px-3">
                  ...
                  <div>
                    <div className="flex items-baseline justify-between">
                      <div className="px-3 py-1 bg-red-200 rounded">
                        <span className="text-sm font-medium text-red-500 leading-tight uppercase">
                          Bug
                        </span>
                      </div>
              ...
              <li className="mt-1">
                ...
                >
                  <div>
                    <div className="flex items-baseline justify-between">
                      <div className="px-3 py-1 bg-indigo-200 rounded">
                        <span className="text-sm font-medium text-indigo-500 leading-tight uppercase">
                          New Feature
                        </span>
                      </div>
                      <div className="flex items-center text-sm text-gray-400">
