  ...
  return (
    <div className="h-screen flex">
        <div className="bg-white w-64 px-8 py-10 border-r border-blue-500 border-opacity-25 rounded-lg">
          ...
          <nav className="mt-8">
            <h3 className="text-md font-semibold text-gray-500 uppercase tracking-wide">Scrumboard</h3>
            <div className="mt-2 -mx-4">
              ...
              <a href="#" className="flex justify-between bg-gradient-to-r from-purple-800 to-blue-500 rounded-lg items-center px-4 py-2 ">
            ...
            <h3 className="text-md mt-8 font-semibold text-gray-500 uppercase tracking-wide">Tags</h3>
            <div className="mt-2 -mx-4">
              <a href="#" className="flex justify-between items-center px-4 py-2">
